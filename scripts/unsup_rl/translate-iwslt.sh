...
ckpt=/data/jive/ozanmodels-iwslt/iwslt3/nmt-r4470a-val014.best.bleu_29.580.ckpt
...
#CUDA_VISIBLE_DEVICES=1 nmtpy translate -S src:/data/jive/simmt/data/multi30k/en-de/test_2017_mscoco.lc.norm.tok.de -s mscoco -o ${mode} ${ckpt}
#cp ${mode}.mscoco.beam6 result/

cd result
#python compare_unks.py xe.mscoco.beam6  sac.mscoco.beam6 /data/jive/simmt/data/multi30k/en-de/test_2017_mscoco.lc.norm.tok.en > nounks.test
...
./multeval.sh eval --refs ${data_dir}/iwslt14-test.tgt.txt --hyps-baseline ${home_dir}/result/xe.test --hyps-sys1 ${home_dir}/result/sac.test  --hyps-sys2 /data/jive/sim2/simmt/result-iwslt/res-erac-iwslt.txt --meteor.language en --latex table.tex --rankDir rank
