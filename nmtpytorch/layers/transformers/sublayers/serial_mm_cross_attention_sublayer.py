...
class SerialMMCrossAttentionSublayer(Module):
    ...
    def __init__(self, model_dim, n_heads, dropout=0.1, attn_dropout=0.0, is_pre_norm=False):
        ...
        """
        super().__init__()
        self.attn_txt = CrossAttentionSublayer(model_dim, n_heads, dropout, attn_dropout, is_pre_norm)
        self.attn_img = CrossAttentionSublayer(model_dim, n_heads, dropout, attn_dropout, is_pre_norm)
    ...
    def forward(self, query, key_txt, value_txt, mask_txt, key_img, value_img,  mask_img=None):
        ...
        attn_img, attn_weights_img = self.attn_img(attn_txt, key_img, value_img, mask_img)
