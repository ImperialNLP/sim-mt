...
class SimultaneousConditionalDecoder(nn.Module):
    """A conditional decoder with attention à la dl4mt-tutorial. Some functionalities
    stripped and changed for simultaneous translation."""
    ...
    def __init__(self, input_size, hidden_size, n_vocab, encoders,
                 ...
                 dropout_out=0,
                 out_logic='simple', dec_inp_activ=None,
