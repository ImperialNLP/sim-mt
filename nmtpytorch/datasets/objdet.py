...
class ObjectDetectionsDataset(Dataset):
    r"""A PyTorch dataset for .npz key-value stores prepared to hold
    `Bottom-up-Top-Down (BUTD)` object detection feat_model.
    ...
    Arguments:
        ...
        feat_mode (str, optional): What type of features to return for a given
            ...
            vectorial pooled features per image. `None` will default to
            `roi_feats` as well.
    """
